...
namespace EmbarkNow\ValueObjects\Identity;

use EmbarkNow\ValueObjects\Exception\InvalidNativeArgumentException;
...
class UUID extends StringLiteral
{
     ...
     * @return UUID
     *
     * @throws \EmbarkNow\ValueObjects\Exception\InvalidNativeArgumentException
     */
